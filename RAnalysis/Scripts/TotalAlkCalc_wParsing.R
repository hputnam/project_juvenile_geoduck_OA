...
setwd("~/MyProjects/Geoduck_Epi/project_juvenile_geoduck_OA/RAnalysis/")
main<-getwd()
...
path<-"Data/TA/20180710" #the location of all your titration files
massfile<-"20180710mass_Run3.csv" # name of your file with masses
titrationfile<-'20180710_Run3.csv'# name of the last titration file run
